                    ...
                    public readonly partial struct RequiredTimesAndWhenArray
                    {
                        ...
                        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                        {
                            ...
                            if (level > ValidationLevel.Basic)
                            {
                                ...
                                result = result.PushSchemaLocation("https://endjin.com/workspaces/test-ml/docs/spec/draft/working-draft.json#/definitions/testCase/properties/assert/properties/mocks/items/properties/calls");
                            }
                        ...
                        public static partial class CorvusValidation
                        {
                            ...
                            internal static ValidationContext ArrayValidationHandler(
                                in RequiredTimesAndWhenArray value,
                                JsonValueKind valueKind,
                                in ValidationContext validationContext,
                                ValidationLevel level)
                            {
                                ...
                                int length = 0;
                                using JsonArrayEnumerator<TestML.WorkingDraft.TestCase.AssertEntity.RequiredCallsAndIdArray.RequiredCallsAndId.RequiredTimesAndWhenArray.RequiredTimesAndWhen> arrayEnumerator = value.EnumerateArray();
