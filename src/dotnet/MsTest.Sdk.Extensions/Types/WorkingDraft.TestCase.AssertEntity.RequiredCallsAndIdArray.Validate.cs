            ...
            public readonly partial struct RequiredCallsAndIdArray
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://endjin.com/workspaces/test-ml/docs/spec/draft/working-draft.json#/definitions/testCase/properties/assert/properties/mocks");
                    }
                ...
                public static partial class CorvusValidation
                {
                    ...
                    internal static ValidationContext ArrayValidationHandler(
                        in RequiredCallsAndIdArray value,
                        JsonValueKind valueKind,
                        in ValidationContext validationContext,
                        ValidationLevel level)
                    {
                        ...
                        int length = 0;
                        using JsonArrayEnumerator<TestML.WorkingDraft.TestCase.AssertEntity.RequiredCallsAndIdArray.RequiredCallsAndId> arrayEnumerator = value.EnumerateArray();
