                ...
                public readonly partial struct ReturnsEntity
                {
                    ...
                    public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        if (level > ValidationLevel.Basic)
                        {
                            ...
                            result = result.PushSchemaLocation("https://endjin.com/workspaces/test-ml/docs/spec/draft/working-draft.json#/definitions/mock/properties/when/items/properties/returns");
                        }
                    ...
                    public static partial class CorvusValidation
                    {
                            ...
                            ValidationLevel level = ValidationLevel.Flag)
                        {
                            ...
                            ValidationContext oneOfResult0 = value.As<TestML.WorkingDraft.JsonValue>().Validate(oneOfChildContext0, level);
                            ...
                            ValidationContext oneOfResult1 = value.As<TestML.WorkingDraft.Mock.RequiredCaseArray.RequiredCase.ReturnsEntity.JsonValueArray>().Validate(oneOfChildContext1, level);
