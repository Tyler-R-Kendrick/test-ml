        ...
        public readonly partial struct RequiredExpr
        {
            ...
            public readonly partial struct PermutationsEntity
            {
                ...
                public readonly partial struct AdditionalPropertiesEntity
                {
                    ...
                    /// </summary>
#if NET8_0_OR_GREATER
                    [CollectionBuilder(typeof(JsonValueArray), "Create")]
#endif
                    public readonly partial struct JsonValueArray
                        : IJsonArray<TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity.JsonValueArray>,
                          IReadOnlyCollection<TestML.WorkingDraft.JsonValue>
                    {
                        /// <summary>
                        /// Gets an empty array.
                        /// </summary>
                        public static JsonValueArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
                        ...
                        /// <inheritdoc/>
                        Corvus.Json.JsonAny IJsonArray<JsonValueArray>.this[int index]
                        {
                            get
                            {
                        ...
                        public TestML.WorkingDraft.JsonValue this[int index]
                        {
                            get
                            {
                                if ((this.backing & Backing.JsonElement) != 0)
                                ...
                                if ((this.backing & Backing.Array) != 0)
                                {
                                    try
                                    {
                                        return this.arrayBacking[index].As<TestML.WorkingDraft.JsonValue>();
                                    }
                                    catch (ArgumentOutOfRangeException ex)
                                    {
                                        throw new IndexOutOfRangeException(ex.Message, ex);
                        ...
                        public static implicit operator JsonValueArray(ImmutableList<JsonAny> value)
                        {
                            return new(value);
                        }
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator ImmutableList<JsonAny>(JsonValueArray value)
                        {
                            return
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator JsonValueArray(JsonArray value)
                        {
                        ...
                        /// </summary>
                        /// <param name="value">The value from which to convert.</param>
                        public static implicit operator JsonArray(JsonValueArray value)
                        {
                            return
                                value.AsArray;
                        }
                        ...
                        /// <summary>
                        /// Initializes a new instance of the <see cref="JsonValueArray"/> struct.
                        /// </summary>
                        ...
                        public static JsonValueArray From(ImmutableList<JsonAny> items)
                        {
                            return new(items);
                        }

                        /// <summary>
                        /// Create an new instance of the <see cref="JsonValueArray"/>" struct from a span of items.
                        /// </summary>
                        ...
                        public static JsonValueArray Create(ReadOnlySpan<TestML.WorkingDraft.JsonValue> items)
                        {
                            return new([..items]);
                        }
                        ...
                        public static JsonValueArray FromItems(params TestML.WorkingDraft.JsonValue[] items)
                        {
                            return new([..items]);
                        }
                        ...
                        public static JsonValueArray FromItems(in TestML.WorkingDraft.JsonValue item1)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static JsonValueArray FromItems(in TestML.WorkingDraft.JsonValue item1, in TestML.WorkingDraft.JsonValue item2)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static JsonValueArray FromItems(in TestML.WorkingDraft.JsonValue item1, in TestML.WorkingDraft.JsonValue item2, in TestML.WorkingDraft.JsonValue item3)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static JsonValueArray FromItems(in TestML.WorkingDraft.JsonValue item1, in TestML.WorkingDraft.JsonValue item2, in TestML.WorkingDraft.JsonValue item3, in TestML.WorkingDraft.JsonValue item4)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static JsonValueArray FromItems(in TestML.WorkingDraft.JsonValue item1, in TestML.WorkingDraft.JsonValue item2, in TestML.WorkingDraft.JsonValue item3, in TestML.WorkingDraft.JsonValue item4, in TestML.WorkingDraft.JsonValue item5)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static JsonValueArray FromItems(in TestML.WorkingDraft.JsonValue item1, in TestML.WorkingDraft.JsonValue item2, in TestML.WorkingDraft.JsonValue item3, in TestML.WorkingDraft.JsonValue item4, in TestML.WorkingDraft.JsonValue item5, in TestML.WorkingDraft.JsonValue item6)
                        {
                        ...
                        /// <returns>An instance of the array constructed from the values.</returns>
                        public static JsonValueArray FromItems(in TestML.WorkingDraft.JsonValue item1, in TestML.WorkingDraft.JsonValue item2, in TestML.WorkingDraft.JsonValue item3, in TestML.WorkingDraft.JsonValue item4, in TestML.WorkingDraft.JsonValue item5, in TestML.WorkingDraft.JsonValue item6, in TestML.WorkingDraft.JsonValue item7)
                        {
                        ...
                        public static JsonValueArray FromRange(IEnumerable<TestML.WorkingDraft.JsonValue> items)
                        {
                            return new([..items]);
                        }
                        ...
                        /// <param name="items">The items from which to construct the instance.</param>
                        /// <returns>An instance of the array constructed from the items .</returns>
                        static JsonValueArray IJsonArray<JsonValueArray>.FromRange(IEnumerable<JsonAny> items)
                        {
                            return new([..items]);
                        }
                        ...
                        /// <param name="items">The items from which to construct the instance.</param>
                        /// <returns>An instance of the array constructed from the items.</returns>
                        static JsonValueArray IJsonArray<JsonValueArray>.FromRange<T>(IEnumerable<T> items)
                        {
                        ...
                        /// <inheritdoc/>
                        IEnumerator<TestML.WorkingDraft.JsonValue> IEnumerable<TestML.WorkingDraft.JsonValue>.GetEnumerator() => this.EnumerateArray();

                        /// <inheritdoc/>
                        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

                        /// <inheritdoc/>
                        int IReadOnlyCollection<TestML.WorkingDraft.JsonValue>.Count => this.GetArrayLength();
                        ...
                        /// <inheritdoc/>
                        public JsonArrayEnumerator<TestML.WorkingDraft.JsonValue> EnumerateArray()
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                        ...
                        /// <inheritdoc/>
                        JsonArrayEnumerator IJsonArray<JsonValueArray>.EnumerateArray()
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                                return new(this.jsonElementBacking);
                        ...
                        /// <inheritdoc/>
                        JsonArrayEnumerator<TItem> IJsonArray<JsonValueArray>.EnumerateArray<TItem>()
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            {
                                return new(this.jsonElementBacking);
                        ...
                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.Add(in JsonAny item1)
                        {
                        ...
                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.Add(params JsonAny[] items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        ...
                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.AddRange<TArray>(in TArray items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        ...
                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.AddRange<TItem>(IEnumerable<TItem> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        ...
                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.AddRange(IEnumerable<JsonAny> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        ...
                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.Insert(int index, in JsonAny item1)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                        }

                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.InsertRange<TArray>(int index, in TArray items)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
                        }

                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                        }

                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.InsertRange(int index, IEnumerable<JsonAny> items)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
                        }

                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                        }

                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.SetItem(int index, in JsonAny value)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                        }

                        /// <inheritdoc/>
                        public JsonValueArray Add(in TestML.WorkingDraft.JsonValue item1)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        ...
                        /// <inheritdoc/>
                        public JsonValueArray Add(params TestML.WorkingDraft.JsonValue[] items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                            foreach (TestML.WorkingDraft.JsonValue item in items)
                            {
                                builder.Add(item.AsAny);
                            }
                        ...
                        /// <inheritdoc/>
                        public JsonValueArray AddRange(IEnumerable<TestML.WorkingDraft.JsonValue> items)
                        {
                            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                            foreach (TestML.WorkingDraft.JsonValue item in items)
                            {
                        ...
                        /// <inheritdoc/>
                        public JsonValueArray Insert(int index, in TestML.WorkingDraft.JsonValue item1)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                        }

                        /// <inheritdoc/>
                        public JsonValueArray InsertRange(int index, IEnumerable<TestML.WorkingDraft.JsonValue> items)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                        }

                        /// <inheritdoc/>
                        public JsonValueArray Replace(in TestML.WorkingDraft.JsonValue oldValue, in TestML.WorkingDraft.JsonValue newValue)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                        }

                        /// <inheritdoc/>
                        public JsonValueArray SetItem(int index, in TestML.WorkingDraft.JsonValue value)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                        }

                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.Remove(in JsonAny oldValue)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                        }

                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.RemoveAt(int index)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
                        }

                        /// <inheritdoc/>
                        JsonValueArray IJsonArray<JsonValueArray>.RemoveRange(int index, int count)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
                        }

                        /// <inheritdoc/>
                        public JsonValueArray Remove(in TestML.WorkingDraft.JsonValue oldValue)
                        {
                            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                        }
                        ...
                        private static class __CorvusArrayHelpers
                        {
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableList(in JsonValueArray arrayInstance)
                            {
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in JsonValueArray arrayInstance)
                            {
                            ...
                            public static ImmutableList<JsonAny> GetImmutableListSetting(in JsonValueArray arrayInstance, int index, in JsonAny value)
                            {
                                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                                {
                                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableListReplacing(in JsonValueArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                            {
                                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                                {
                                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableListWithout(in JsonValueArray arrayInstance, in JsonAny item)
                            {
                                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                                {
                                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in JsonValueArray arrayInstance, int index, int count)
                            {
                                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                                {
                                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                            ...
                            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableListWith(in JsonValueArray arrayInstance, int index, in JsonAny value)
                            {
                                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                                {
                                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                            ...
                            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in JsonValueArray arrayInstance, int index, TEnumerable values)
