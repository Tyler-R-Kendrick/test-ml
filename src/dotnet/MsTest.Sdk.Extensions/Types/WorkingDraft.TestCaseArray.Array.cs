...
public readonly partial struct WorkingDraft
{
    ...
    /// </summary>
#if NET8_0_OR_GREATER
    [CollectionBuilder(typeof(TestCaseArray), "Create")]
#endif
    public readonly partial struct TestCaseArray
        : IJsonArray<TestML.WorkingDraft.TestCaseArray>,
          IReadOnlyCollection<TestML.WorkingDraft.TestCase>
    {
        /// <summary>
        /// Gets an empty array.
        /// </summary>
        public static TestCaseArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
        ...
        /// <inheritdoc/>
        Corvus.Json.JsonAny IJsonArray<TestCaseArray>.this[int index]
        {
            get
            {
        ...
        public TestML.WorkingDraft.TestCase this[int index]
        {
            get
            {
                if ((this.backing & Backing.JsonElement) != 0)
                ...
                if ((this.backing & Backing.Array) != 0)
                {
                    try
                    {
                        return this.arrayBacking[index].As<TestML.WorkingDraft.TestCase>();
                    }
                    catch (ArgumentOutOfRangeException ex)
                    {
                        throw new IndexOutOfRangeException(ex.Message, ex);
        ...
        public static implicit operator TestCaseArray(ImmutableList<JsonAny> value)
        {
            return new(value);
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator ImmutableList<JsonAny>(TestCaseArray value)
        {
            return
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator TestCaseArray(JsonArray value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonArray(TestCaseArray value)
        {
            return
                value.AsArray;
        }
        ...
        public static TestCaseArray From(ImmutableList<JsonAny> items)
        {
            return new(items);
        }

        /// <summary>
        /// Create an new instance of the <see cref="TestCaseArray"/>" struct from a span of items.
        /// </summary>
        ...
        public static TestCaseArray Create(ReadOnlySpan<TestML.WorkingDraft.TestCase> items)
        {
            return new([..items]);
        }
        ...
        public static TestCaseArray FromItems(params TestML.WorkingDraft.TestCase[] items)
        {
            return new([..items]);
        }
        ...
        public static TestCaseArray FromItems(in TestML.WorkingDraft.TestCase item1)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TestCaseArray FromItems(in TestML.WorkingDraft.TestCase item1, in TestML.WorkingDraft.TestCase item2)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TestCaseArray FromItems(in TestML.WorkingDraft.TestCase item1, in TestML.WorkingDraft.TestCase item2, in TestML.WorkingDraft.TestCase item3)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TestCaseArray FromItems(in TestML.WorkingDraft.TestCase item1, in TestML.WorkingDraft.TestCase item2, in TestML.WorkingDraft.TestCase item3, in TestML.WorkingDraft.TestCase item4)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TestCaseArray FromItems(in TestML.WorkingDraft.TestCase item1, in TestML.WorkingDraft.TestCase item2, in TestML.WorkingDraft.TestCase item3, in TestML.WorkingDraft.TestCase item4, in TestML.WorkingDraft.TestCase item5)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TestCaseArray FromItems(in TestML.WorkingDraft.TestCase item1, in TestML.WorkingDraft.TestCase item2, in TestML.WorkingDraft.TestCase item3, in TestML.WorkingDraft.TestCase item4, in TestML.WorkingDraft.TestCase item5, in TestML.WorkingDraft.TestCase item6)
        {
        ...
        /// <returns>An instance of the array constructed from the values.</returns>
        public static TestCaseArray FromItems(in TestML.WorkingDraft.TestCase item1, in TestML.WorkingDraft.TestCase item2, in TestML.WorkingDraft.TestCase item3, in TestML.WorkingDraft.TestCase item4, in TestML.WorkingDraft.TestCase item5, in TestML.WorkingDraft.TestCase item6, in TestML.WorkingDraft.TestCase item7)
        {
        ...
        public static TestCaseArray FromRange(IEnumerable<TestML.WorkingDraft.TestCase> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items .</returns>
        static TestCaseArray IJsonArray<TestCaseArray>.FromRange(IEnumerable<JsonAny> items)
        {
            return new([..items]);
        }
        ...
        /// <param name="items">The items from which to construct the instance.</param>
        /// <returns>An instance of the array constructed from the items.</returns>
        static TestCaseArray IJsonArray<TestCaseArray>.FromRange<T>(IEnumerable<T> items)
        {
        ...
        /// <inheritdoc/>
        IEnumerator<TestML.WorkingDraft.TestCase> IEnumerable<TestML.WorkingDraft.TestCase>.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

        /// <inheritdoc/>
        int IReadOnlyCollection<TestML.WorkingDraft.TestCase>.Count => this.GetArrayLength();
        ...
        /// <inheritdoc/>
        public JsonArrayEnumerator<TestML.WorkingDraft.TestCase> EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator IJsonArray<TestCaseArray>.EnumerateArray()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        JsonArrayEnumerator<TItem> IJsonArray<TestCaseArray>.EnumerateArray<TItem>()
        {
            if ((this.backing & Backing.JsonElement) != 0)
            {
                return new(this.jsonElementBacking);
        ...
        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.Add(in JsonAny item1)
        {
        ...
        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.Add(params JsonAny[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.AddRange<TArray>(in TArray items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.AddRange<TItem>(IEnumerable<TItem> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.AddRange(IEnumerable<JsonAny> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.Insert(int index, in JsonAny item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.InsertRange<TArray>(int index, in TArray items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
        }

        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.InsertRange(int index, IEnumerable<JsonAny> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
        }

        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.SetItem(int index, in JsonAny value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        public TestCaseArray Add(in TestML.WorkingDraft.TestCase item1)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
        ...
        /// <inheritdoc/>
        public TestCaseArray Add(params TestML.WorkingDraft.TestCase[] items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (TestML.WorkingDraft.TestCase item in items)
            {
                builder.Add(item.AsAny);
            }
        ...
        /// <inheritdoc/>
        public TestCaseArray AddRange(IEnumerable<TestML.WorkingDraft.TestCase> items)
        {
            ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
            foreach (TestML.WorkingDraft.TestCase item in items)
            {
        ...
        /// <inheritdoc/>
        public TestCaseArray Insert(int index, in TestML.WorkingDraft.TestCase item1)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
        }

        /// <inheritdoc/>
        public TestCaseArray InsertRange(int index, IEnumerable<TestML.WorkingDraft.TestCase> items)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
        }

        /// <inheritdoc/>
        public TestCaseArray Replace(in TestML.WorkingDraft.TestCase oldValue, in TestML.WorkingDraft.TestCase newValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
        }

        /// <inheritdoc/>
        public TestCaseArray SetItem(int index, in TestML.WorkingDraft.TestCase value)
        {
            return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
        }

        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.Remove(in JsonAny oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }

        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.RemoveAt(int index)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
        }

        /// <inheritdoc/>
        TestCaseArray IJsonArray<TestCaseArray>.RemoveRange(int index, int count)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
        }

        /// <inheritdoc/>
        public TestCaseArray Remove(in TestML.WorkingDraft.TestCase oldValue)
        {
            return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
        }
        ...
        private static class __CorvusArrayHelpers
        {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableList(in TestCaseArray arrayInstance)
            {
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in TestCaseArray arrayInstance)
            {
            ...
            public static ImmutableList<JsonAny> GetImmutableListSetting(in TestCaseArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListReplacing(in TestCaseArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithout(in TestCaseArray arrayInstance, in JsonAny item)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in TestCaseArray arrayInstance, int index, int count)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            // <exception cref = "InvalidOperationException">The value is not an array.</exception>
            // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith(in TestCaseArray arrayInstance, int index, in JsonAny value)
            {
                if ((arrayInstance.backing & Backing.JsonElement) != 0)
                {
                    if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
            ...
            /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
            /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
            public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in TestCaseArray arrayInstance, int index, TEnumerable values)
