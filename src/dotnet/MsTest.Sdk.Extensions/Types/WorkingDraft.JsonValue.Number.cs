...
#if NET8_0_OR_GREATER
        : IJsonNumber<TestML.WorkingDraft.JsonValue>,
          IAdditionOperators<TestML.WorkingDraft.JsonValue, TestML.WorkingDraft.JsonValue, TestML.WorkingDraft.JsonValue>,
          ISubtractionOperators<TestML.WorkingDraft.JsonValue, TestML.WorkingDraft.JsonValue, TestML.WorkingDraft.JsonValue>,
          IMultiplyOperators<TestML.WorkingDraft.JsonValue, TestML.WorkingDraft.JsonValue, TestML.WorkingDraft.JsonValue>,
          IDivisionOperators<TestML.WorkingDraft.JsonValue, TestML.WorkingDraft.JsonValue, TestML.WorkingDraft.JsonValue>,
          IIncrementOperators<TestML.WorkingDraft.JsonValue>,
          IDecrementOperators<TestML.WorkingDraft.JsonValue>
#else
        : IJsonNumber<TestML.WorkingDraft.JsonValue>
#endif
    {
        ...
        public static implicit operator JsonValue(JsonNumber value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonNumber(JsonValue value)
        {
            return
                value.AsNumber;
        }
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(byte value)
        {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(decimal value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(short value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(int value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(long value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator Int128(JsonValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(Int128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(sbyte value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(Half value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(float value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(ushort value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(uint value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(ulong value)
        {
            return new(new BinaryJsonNumber(value));
        }
        ...
        public static explicit operator UInt128(JsonValue value)
        {
            if ((value.backing & Backing.JsonElement) != 0)
            {
        ...
        /// <param name="value">The value from which to convert.</param>
        /// <returns>An instance of the <see cref="JsonValue"/>.</returns>
        public static explicit operator JsonValue(UInt128 value)
        {
            return new(new BinaryJsonNumber(value));
        }
#endif
        ...
        /// <returns>The result of the operation.</returns>
        public static JsonValue operator ++(JsonValue value)
        {
        ...
        /// </returns>
        public static int Compare(in JsonValue lhs, in JsonValue rhs)
        {
