...
#if NET8_0_OR_GREATER
                : IJsonNumber<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity>,
                  IAdditionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity>,
                  ISubtractionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity>,
                  IMultiplyOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity>,
                  IDivisionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity>,
                  IIncrementOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity>,
                  IDecrementOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity>
#else
                : IJsonNumber<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity>
#endif
            {
                ...
                public TimeoutEntity(long value)
                ...
                public static implicit operator TimeoutEntity(JsonNumber value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonNumber(TimeoutEntity value)
                {
                    return
                        value.AsNumber;
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonInteger(TimeoutEntity value)
                {
                    return
                ...
                public static explicit operator byte(TimeoutEntity value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(byte value)
                {
                ...
                public static explicit operator decimal(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(decimal value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator double(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(double value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator short(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(short value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator int(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(int value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static implicit operator long(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static implicit operator TimeoutEntity(long value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator Int128(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(Int128 value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                public static explicit operator sbyte(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(sbyte value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator Half(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(Half value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                public static explicit operator float(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(float value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator ushort(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(ushort value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator uint(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(uint value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator ulong(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(ulong value)
                {
                    return new(new BinaryJsonNumber(value));
                }
                ...
                public static explicit operator UInt128(TimeoutEntity value)
                {
                    if ((value.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <param name="value">The value from which to convert.</param>
                /// <returns>An instance of the <see cref="TimeoutEntity"/>.</returns>
                public static explicit operator TimeoutEntity(UInt128 value)
                {
                    return new(new BinaryJsonNumber(value));
                }
#endif
                ...
                /// </returns>
                public static bool operator <(TimeoutEntity left, TimeoutEntity right)
                {
                ...
                public static TimeoutEntity operator +(TimeoutEntity left, TimeoutEntity right)
                {
                ...
                /// <returns>The result of the operation.</returns>
                public static TimeoutEntity operator ++(TimeoutEntity value)
                {
                ...
                /// </returns>
                public static int Compare(in TimeoutEntity lhs, in TimeoutEntity rhs)
                {
