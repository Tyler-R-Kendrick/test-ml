...
public readonly partial struct WorkingDraft
{
    ...
    public readonly partial struct JsonValue
        : IJsonBoolean<TestML.WorkingDraft.JsonValue>
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonValue(JsonBoolean value)
        {
        ...
        /// </summary>
        /// <param name="value">The value from which to convert.</param>
        public static implicit operator JsonBoolean(JsonValue value)
        {
            return
                value.AsBoolean;
        }
