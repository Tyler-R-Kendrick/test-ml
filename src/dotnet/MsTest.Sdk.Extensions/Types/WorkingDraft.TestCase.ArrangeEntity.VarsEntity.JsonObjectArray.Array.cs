    ...
    public readonly partial struct TestCase
    {
        ...
        public readonly partial struct ArrangeEntity
        {
            ...
            public readonly partial struct VarsEntity
            {
                ...
                /// </summary>
#if NET8_0_OR_GREATER
                [CollectionBuilder(typeof(JsonObjectArray), "Create")]
#endif
                public readonly partial struct JsonObjectArray
                    : IJsonArray<TestML.WorkingDraft.TestCase.ArrangeEntity.VarsEntity.JsonObjectArray>,
                      IReadOnlyCollection<Corvus.Json.JsonObject>
                {
                    /// <summary>
                    /// Gets an empty array.
                    /// </summary>
                    public static JsonObjectArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
                    ...
                    /// <inheritdoc/>
                    Corvus.Json.JsonAny IJsonArray<JsonObjectArray>.this[int index]
                    {
                        get
                        {
                    ...
                    public Corvus.Json.JsonObject this[int index]
                    {
                        get
                        {
                            if ((this.backing & Backing.JsonElement) != 0)
                            ...
                            if ((this.backing & Backing.Array) != 0)
                            {
                                try
                                {
                                    return this.arrayBacking[index].As<Corvus.Json.JsonObject>();
                                }
                                catch (ArgumentOutOfRangeException ex)
                                {
                                    throw new IndexOutOfRangeException(ex.Message, ex);
                    ...
                    public static implicit operator JsonObjectArray(ImmutableList<JsonAny> value)
                    {
                        return new(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator ImmutableList<JsonAny>(JsonObjectArray value)
                    {
                        return
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonObjectArray(JsonArray value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonArray(JsonObjectArray value)
                    {
                        return
                            value.AsArray;
                    }
                    ...
                    public static JsonObjectArray From(ImmutableList<JsonAny> items)
                    {
                        return new(items);
                    }

                    /// <summary>
                    /// Create an new instance of the <see cref="JsonObjectArray"/>" struct from a span of items.
                    /// </summary>
                    ...
                    public static JsonObjectArray Create(ReadOnlySpan<Corvus.Json.JsonObject> items)
                    {
                        return new([..items]);
                    }
                    ...
                    public static JsonObjectArray FromItems(params Corvus.Json.JsonObject[] items)
                    {
                        return new([..items]);
                    }
                    ...
                    public static JsonObjectArray FromItems(in Corvus.Json.JsonObject item1)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static JsonObjectArray FromItems(in Corvus.Json.JsonObject item1, in Corvus.Json.JsonObject item2)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static JsonObjectArray FromItems(in Corvus.Json.JsonObject item1, in Corvus.Json.JsonObject item2, in Corvus.Json.JsonObject item3)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static JsonObjectArray FromItems(in Corvus.Json.JsonObject item1, in Corvus.Json.JsonObject item2, in Corvus.Json.JsonObject item3, in Corvus.Json.JsonObject item4)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static JsonObjectArray FromItems(in Corvus.Json.JsonObject item1, in Corvus.Json.JsonObject item2, in Corvus.Json.JsonObject item3, in Corvus.Json.JsonObject item4, in Corvus.Json.JsonObject item5)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static JsonObjectArray FromItems(in Corvus.Json.JsonObject item1, in Corvus.Json.JsonObject item2, in Corvus.Json.JsonObject item3, in Corvus.Json.JsonObject item4, in Corvus.Json.JsonObject item5, in Corvus.Json.JsonObject item6)
                    {
                    ...
                    /// <returns>An instance of the array constructed from the values.</returns>
                    public static JsonObjectArray FromItems(in Corvus.Json.JsonObject item1, in Corvus.Json.JsonObject item2, in Corvus.Json.JsonObject item3, in Corvus.Json.JsonObject item4, in Corvus.Json.JsonObject item5, in Corvus.Json.JsonObject item6, in Corvus.Json.JsonObject item7)
                    {
                    ...
                    public static JsonObjectArray FromRange(IEnumerable<Corvus.Json.JsonObject> items)
                    {
                        return new([..items]);
                    }
                    ...
                    /// <param name="items">The items from which to construct the instance.</param>
                    /// <returns>An instance of the array constructed from the items .</returns>
                    static JsonObjectArray IJsonArray<JsonObjectArray>.FromRange(IEnumerable<JsonAny> items)
                    {
                        return new([..items]);
                    }
                    ...
                    /// <param name="items">The items from which to construct the instance.</param>
                    /// <returns>An instance of the array constructed from the items.</returns>
                    static JsonObjectArray IJsonArray<JsonObjectArray>.FromRange<T>(IEnumerable<T> items)
                    {
                    ...
                    /// <inheritdoc/>
                    IEnumerator<Corvus.Json.JsonObject> IEnumerable<Corvus.Json.JsonObject>.GetEnumerator() => this.EnumerateArray();

                    /// <inheritdoc/>
                    IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

                    /// <inheritdoc/>
                    int IReadOnlyCollection<Corvus.Json.JsonObject>.Count => this.GetArrayLength();
                    ...
                    /// <inheritdoc/>
                    public JsonArrayEnumerator<Corvus.Json.JsonObject> EnumerateArray()
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <inheritdoc/>
                    JsonArrayEnumerator IJsonArray<JsonObjectArray>.EnumerateArray()
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                            return new(this.jsonElementBacking);
                    ...
                    /// <inheritdoc/>
                    JsonArrayEnumerator<TItem> IJsonArray<JsonObjectArray>.EnumerateArray<TItem>()
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        {
                            return new(this.jsonElementBacking);
                    ...
                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.Add(in JsonAny item1)
                    {
                    ...
                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.Add(params JsonAny[] items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.AddRange<TArray>(in TArray items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.AddRange<TItem>(IEnumerable<TItem> items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.AddRange(IEnumerable<JsonAny> items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.Insert(int index, in JsonAny item1)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                    }

                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.InsertRange<TArray>(int index, in TArray items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
                    }

                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                    }

                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.InsertRange(int index, IEnumerable<JsonAny> items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
                    }

                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                    }

                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.SetItem(int index, in JsonAny value)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                    }

                    /// <inheritdoc/>
                    public JsonObjectArray Add(in Corvus.Json.JsonObject item1)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    ...
                    /// <inheritdoc/>
                    public JsonObjectArray Add(params Corvus.Json.JsonObject[] items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        foreach (Corvus.Json.JsonObject item in items)
                        {
                            builder.Add(item.AsAny);
                        }
                    ...
                    /// <inheritdoc/>
                    public JsonObjectArray AddRange(IEnumerable<Corvus.Json.JsonObject> items)
                    {
                        ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                        foreach (Corvus.Json.JsonObject item in items)
                        {
                    ...
                    /// <inheritdoc/>
                    public JsonObjectArray Insert(int index, in Corvus.Json.JsonObject item1)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                    }

                    /// <inheritdoc/>
                    public JsonObjectArray InsertRange(int index, IEnumerable<Corvus.Json.JsonObject> items)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                    }

                    /// <inheritdoc/>
                    public JsonObjectArray Replace(in Corvus.Json.JsonObject oldValue, in Corvus.Json.JsonObject newValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                    }

                    /// <inheritdoc/>
                    public JsonObjectArray SetItem(int index, in Corvus.Json.JsonObject value)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                    }

                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.Remove(in JsonAny oldValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                    }

                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.RemoveAt(int index)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
                    }

                    /// <inheritdoc/>
                    JsonObjectArray IJsonArray<JsonObjectArray>.RemoveRange(int index, int count)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
                    }

                    /// <inheritdoc/>
                    public JsonObjectArray Remove(in Corvus.Json.JsonObject oldValue)
                    {
                        return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                    }
                    ...
                    private static class __CorvusArrayHelpers
                    {
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableList(in JsonObjectArray arrayInstance)
                        {
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in JsonObjectArray arrayInstance)
                        {
                        ...
                        public static ImmutableList<JsonAny> GetImmutableListSetting(in JsonObjectArray arrayInstance, int index, in JsonAny value)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListReplacing(in JsonObjectArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWithout(in JsonObjectArray arrayInstance, in JsonAny item)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in JsonObjectArray arrayInstance, int index, int count)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWith(in JsonObjectArray arrayInstance, int index, in JsonAny value)
                        {
                            if ((arrayInstance.backing & Backing.JsonElement) != 0)
                            {
                                if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                        ...
                        /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                        /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                        public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in JsonObjectArray arrayInstance, int index, TEnumerable values)
