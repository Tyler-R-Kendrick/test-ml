    ...
    public readonly partial struct Times
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://endjin.com/workspaces/test-ml/docs/spec/draft/working-draft.json#/definitions/times");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                static bool StringValidator(ReadOnlySpan<char> input, in Corvus.Json.Validate.ValidationContextWrapper context, out ValidationContext result)
                {
                    ...
                    if (Pattern.IsMatch(input))
                    {
                        ...
                        {
                            result = result.WithResult(isValid: true, validationLocationReducedPathModifier: new JsonReference("pattern"), $"Validation pattern - {input.ToString()} matched '^(?i)(never|always|exactly\\(\\d+\\)|atLeast\\(\\d+\\)|atMost\\(\\d+\\))$'");
                        }
                    }
                    else
                    {
                        ...
                        {
                            result = result.WithResult(isValid: false, validationLocationReducedPathModifier: new JsonReference("pattern"), $"Validation pattern - {input.ToString()} did not match '^(?i)(never|always|exactly\\(\\d+\\)|atLeast\\(\\d+\\)|atMost\\(\\d+\\))$'");
                        }
                        else
                        {
                            result = result.WithResult(isValid: false, validationLocationReducedPathModifier: new JsonReference("pattern"), "Validation pattern - The value did not match '^(?i)(never|always|exactly\\(\\d+\\)|atLeast\\(\\d+\\)|atMost\\(\\d+\\))$'");
                        }
                    }
            ...
            [GeneratedRegex("^(?i)(never|always|exactly\\(\\d+\\)|atLeast\\(\\d+\\)|atMost\\(\\d+\\))$")]
            private static partial Regex CreatePattern();
#else
            private static Regex CreatePattern() => new("^(?i)(never|always|exactly\\(\\d+\\)|atLeast\\(\\d+\\)|atMost\\(\\d+\\))$", RegexOptions.Compiled);
#endif
        }
    }
}
