...
public readonly partial struct WorkingDraft
{
    ...
    public readonly partial struct TestCase
    {
        ...
        public readonly partial struct RequiredExpr
        {
            ...
            /// Generated from JSON Schema.
            /// </summary>
            public readonly partial struct RequiredAttempts
            {
                /// <summary>
                /// Generated from JSON Schema.
                /// </summary>
                public readonly partial struct AttemptsEntity
#if NET8_0_OR_GREATER
                    : IJsonNumber<TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity>,
                      IAdditionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity, TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity, TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity>,
                      ISubtractionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity, TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity, TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity>,
                      IMultiplyOperators<TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity, TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity, TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity>,
                      IDivisionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity, TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity, TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity>,
                      IIncrementOperators<TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity>,
                      IDecrementOperators<TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity>
#else
                    : IJsonNumber<TestML.WorkingDraft.TestCase.RequiredExpr.RequiredAttempts.AttemptsEntity>
#endif
                {
                    /// <summary>
                    /// Initializes a new instance of the <see cref = "AttemptsEntity"/> struct.
                    /// </summary>
                    /// <param name="value">The value from which to construct the instance.</param>
                    public AttemptsEntity(long value)
                    ...
                    public static implicit operator AttemptsEntity(JsonNumber value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonNumber(AttemptsEntity value)
                    {
                        return
                            value.AsNumber;
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonInteger(AttemptsEntity value)
                    {
                        return
                    ...
                    public static explicit operator byte(AttemptsEntity value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(byte value)
                    {
                    ...
                    public static explicit operator decimal(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(decimal value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator double(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(double value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator short(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(short value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator int(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(int value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static implicit operator long(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static implicit operator AttemptsEntity(long value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator Int128(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(Int128 value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    public static explicit operator sbyte(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(sbyte value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator Half(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(Half value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    public static explicit operator float(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(float value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator ushort(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(ushort value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator uint(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(uint value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator ulong(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(ulong value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator UInt128(AttemptsEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AttemptsEntity"/>.</returns>
                    public static explicit operator AttemptsEntity(UInt128 value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    /// </returns>
                    public static bool operator <(AttemptsEntity left, AttemptsEntity right)
                    {
                    ...
                    public static AttemptsEntity operator +(AttemptsEntity left, AttemptsEntity right)
                    {
                    ...
                    /// <returns>The result of the operation.</returns>
                    public static AttemptsEntity operator ++(AttemptsEntity value)
                    {
                    ...
                    /// </returns>
                    public static int Compare(in AttemptsEntity lhs, in AttemptsEntity rhs)
                    {
