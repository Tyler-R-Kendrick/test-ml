            ...
            public readonly partial struct ThrowsEntity
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://endjin.com/workspaces/test-ml/docs/spec/draft/working-draft.json#/definitions/testCase/properties/assert/properties/throws");
                    }
                ...
                public static partial class CorvusValidation
                {
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        ValidationContext oneOfResult1 = value.As<TestML.WorkingDraft.TestCase.AssertEntity.ThrowsEntity.JsonStringArray>().Validate(oneOfChildContext1, level);
