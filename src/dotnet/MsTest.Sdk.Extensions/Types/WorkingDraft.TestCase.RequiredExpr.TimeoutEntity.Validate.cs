            ...
            public readonly partial struct TimeoutEntity
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://endjin.com/workspaces/test-ml/docs/spec/draft/working-draft.json#/definitions/testCase/properties/act/properties/timeout");
                    }
                ...
                public static partial class CorvusValidation
                {
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        ValidationContext oneOfResult0 = value.As<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf0Entity>().Validate(oneOfChildContext0, level);
                        ...
                        ValidationContext oneOfResult1 = value.As<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity>().Validate(oneOfChildContext1, level);
