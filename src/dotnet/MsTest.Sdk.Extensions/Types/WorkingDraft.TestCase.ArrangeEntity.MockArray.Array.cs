...
public readonly partial struct WorkingDraft
{
    ...
    public readonly partial struct TestCase
    {
        ...
        public readonly partial struct ArrangeEntity
        {
            ...
            /// </summary>
#if NET8_0_OR_GREATER
            [CollectionBuilder(typeof(MockArray), "Create")]
#endif
            public readonly partial struct MockArray
                : IJsonArray<TestML.WorkingDraft.TestCase.ArrangeEntity.MockArray>,
                  IReadOnlyCollection<TestML.WorkingDraft.Mock>
            {
                /// <summary>
                /// Gets an empty array.
                /// </summary>
                public static MockArray EmptyArray { get; } = From(ImmutableList<JsonAny>.Empty);
                ...
                /// <inheritdoc/>
                Corvus.Json.JsonAny IJsonArray<MockArray>.this[int index]
                {
                    get
                    {
                ...
                public TestML.WorkingDraft.Mock this[int index]
                {
                    get
                    {
                        if ((this.backing & Backing.JsonElement) != 0)
                        ...
                        if ((this.backing & Backing.Array) != 0)
                        {
                            try
                            {
                                return this.arrayBacking[index].As<TestML.WorkingDraft.Mock>();
                            }
                            catch (ArgumentOutOfRangeException ex)
                            {
                                throw new IndexOutOfRangeException(ex.Message, ex);
                ...
                public static implicit operator MockArray(ImmutableList<JsonAny> value)
                {
                    return new(value);
                }
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator ImmutableList<JsonAny>(MockArray value)
                {
                    return
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator MockArray(JsonArray value)
                {
                ...
                /// </summary>
                /// <param name="value">The value from which to convert.</param>
                public static implicit operator JsonArray(MockArray value)
                {
                    return
                        value.AsArray;
                }
                ...
                /// <summary>
                /// Initializes a new instance of the <see cref="MockArray"/> struct.
                /// </summary>
                ...
                public static MockArray From(ImmutableList<JsonAny> items)
                {
                    return new(items);
                }

                /// <summary>
                /// Create an new instance of the <see cref="MockArray"/>" struct from a span of items.
                /// </summary>
                ...
                public static MockArray Create(ReadOnlySpan<TestML.WorkingDraft.Mock> items)
                {
                    return new([..items]);
                }
                ...
                public static MockArray FromItems(params TestML.WorkingDraft.Mock[] items)
                {
                    return new([..items]);
                }
                ...
                public static MockArray FromItems(in TestML.WorkingDraft.Mock item1)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static MockArray FromItems(in TestML.WorkingDraft.Mock item1, in TestML.WorkingDraft.Mock item2)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static MockArray FromItems(in TestML.WorkingDraft.Mock item1, in TestML.WorkingDraft.Mock item2, in TestML.WorkingDraft.Mock item3)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static MockArray FromItems(in TestML.WorkingDraft.Mock item1, in TestML.WorkingDraft.Mock item2, in TestML.WorkingDraft.Mock item3, in TestML.WorkingDraft.Mock item4)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static MockArray FromItems(in TestML.WorkingDraft.Mock item1, in TestML.WorkingDraft.Mock item2, in TestML.WorkingDraft.Mock item3, in TestML.WorkingDraft.Mock item4, in TestML.WorkingDraft.Mock item5)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static MockArray FromItems(in TestML.WorkingDraft.Mock item1, in TestML.WorkingDraft.Mock item2, in TestML.WorkingDraft.Mock item3, in TestML.WorkingDraft.Mock item4, in TestML.WorkingDraft.Mock item5, in TestML.WorkingDraft.Mock item6)
                {
                ...
                /// <returns>An instance of the array constructed from the values.</returns>
                public static MockArray FromItems(in TestML.WorkingDraft.Mock item1, in TestML.WorkingDraft.Mock item2, in TestML.WorkingDraft.Mock item3, in TestML.WorkingDraft.Mock item4, in TestML.WorkingDraft.Mock item5, in TestML.WorkingDraft.Mock item6, in TestML.WorkingDraft.Mock item7)
                {
                ...
                public static MockArray FromRange(IEnumerable<TestML.WorkingDraft.Mock> items)
                {
                    return new([..items]);
                }
                ...
                /// <param name="items">The items from which to construct the instance.</param>
                /// <returns>An instance of the array constructed from the items .</returns>
                static MockArray IJsonArray<MockArray>.FromRange(IEnumerable<JsonAny> items)
                {
                    return new([..items]);
                }
                ...
                /// <param name="items">The items from which to construct the instance.</param>
                /// <returns>An instance of the array constructed from the items.</returns>
                static MockArray IJsonArray<MockArray>.FromRange<T>(IEnumerable<T> items)
                {
                ...
                /// <inheritdoc/>
                IEnumerator<TestML.WorkingDraft.Mock> IEnumerable<TestML.WorkingDraft.Mock>.GetEnumerator() => this.EnumerateArray();

                /// <inheritdoc/>
                IEnumerator IEnumerable.GetEnumerator() => this.EnumerateArray();

                /// <inheritdoc/>
                int IReadOnlyCollection<TestML.WorkingDraft.Mock>.Count => this.GetArrayLength();
                ...
                /// <inheritdoc/>
                public JsonArrayEnumerator<TestML.WorkingDraft.Mock> EnumerateArray()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                ...
                /// <inheritdoc/>
                JsonArrayEnumerator IJsonArray<MockArray>.EnumerateArray()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new(this.jsonElementBacking);
                ...
                /// <inheritdoc/>
                JsonArrayEnumerator<TItem> IJsonArray<MockArray>.EnumerateArray<TItem>()
                {
                    if ((this.backing & Backing.JsonElement) != 0)
                    {
                        return new(this.jsonElementBacking);
                ...
                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.Add(in JsonAny item1)
                {
                ...
                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.Add(params JsonAny[] items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                ...
                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.AddRange<TArray>(in TArray items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                ...
                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.AddRange<TItem>(IEnumerable<TItem> items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                ...
                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.AddRange(IEnumerable<JsonAny> items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                ...
                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.Insert(int index, in JsonAny item1)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                }

                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.InsertRange<TArray>(int index, in TArray items)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.EnumerateArray()));
                }

                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.InsertRange<TItem>(int index, IEnumerable<TItem> items)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                }

                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.InsertRange(int index, IEnumerable<JsonAny> items)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items));
                }

                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.Replace(in JsonAny oldValue, in JsonAny newValue)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                }

                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.SetItem(int index, in JsonAny value)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                }

                /// <inheritdoc/>
                public MockArray Add(in TestML.WorkingDraft.Mock item1)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                ...
                /// <inheritdoc/>
                public MockArray Add(params TestML.WorkingDraft.Mock[] items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    foreach (TestML.WorkingDraft.Mock item in items)
                    {
                        builder.Add(item.AsAny);
                    }
                ...
                /// <inheritdoc/>
                public MockArray AddRange(IEnumerable<TestML.WorkingDraft.Mock> items)
                {
                    ImmutableList<JsonAny>.Builder builder = __CorvusArrayHelpers.GetImmutableListBuilder(this);
                    foreach (TestML.WorkingDraft.Mock item in items)
                    {
                ...
                /// <inheritdoc/>
                public MockArray Insert(int index, in TestML.WorkingDraft.Mock item1)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, item1));
                }

                /// <inheritdoc/>
                public MockArray InsertRange(int index, IEnumerable<TestML.WorkingDraft.Mock> items)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWith(this, index, items.Select(item => item.AsAny)));
                }

                /// <inheritdoc/>
                public MockArray Replace(in TestML.WorkingDraft.Mock oldValue, in TestML.WorkingDraft.Mock newValue)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListReplacing(this, oldValue, newValue));
                }

                /// <inheritdoc/>
                public MockArray SetItem(int index, in TestML.WorkingDraft.Mock value)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListSetting(this, index, value));
                }

                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.Remove(in JsonAny oldValue)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                }

                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.RemoveAt(int index)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, 1));
                }

                /// <inheritdoc/>
                MockArray IJsonArray<MockArray>.RemoveRange(int index, int count)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWithoutRange(this, index, count));
                }

                /// <inheritdoc/>
                public MockArray Remove(in TestML.WorkingDraft.Mock oldValue)
                {
                    return new(__CorvusArrayHelpers.GetImmutableListWithout(this, oldValue));
                }
                ...
                private static class __CorvusArrayHelpers
                {
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableList(in MockArray arrayInstance)
                    {
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    public static ImmutableList<JsonAny>.Builder GetImmutableListBuilder(in MockArray arrayInstance)
                    {
                    ...
                    public static ImmutableList<JsonAny> GetImmutableListSetting(in MockArray arrayInstance, int index, in JsonAny value)
                    {
                        if ((arrayInstance.backing & Backing.JsonElement) != 0)
                        {
                            if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableListReplacing(in MockArray arrayInstance, in JsonAny oldItem, in JsonAny newItem)
                    {
                        if ((arrayInstance.backing & Backing.JsonElement) != 0)
                        {
                            if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableListWithout(in MockArray arrayInstance, in JsonAny item)
                    {
                        if ((arrayInstance.backing & Backing.JsonElement) != 0)
                        {
                            if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableListWithoutRange(in MockArray arrayInstance, int index, int count)
                    {
                        if ((arrayInstance.backing & Backing.JsonElement) != 0)
                        {
                            if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                    ...
                    // <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    // <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableListWith(in MockArray arrayInstance, int index, in JsonAny value)
                    {
                        if ((arrayInstance.backing & Backing.JsonElement) != 0)
                        {
                            if (arrayInstance.jsonElementBacking.ValueKind == JsonValueKind.Array)
                    ...
                    /// <exception cref = "InvalidOperationException">The value is not an array.</exception>
                    /// <exception cref = "IndexOutOfRangeException">Thrown if the range is beyond the bounds of the array.</exception>
                    public static ImmutableList<JsonAny> GetImmutableListWith<TEnumerable>(in MockArray arrayInstance, int index, TEnumerable values)
