...
#if NET8_0_OR_GREATER
                    : IJsonNumber<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity>,
                      IAdditionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity>,
                      ISubtractionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity>,
                      IMultiplyOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity>,
                      IDivisionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity, TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity>,
                      IIncrementOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity>,
                      IDecrementOperators<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity>
#else
                    : IJsonNumber<TestML.WorkingDraft.TestCase.RequiredExpr.TimeoutEntity.OneOf1Entity>
#endif
                {
                    ...
                    public static explicit operator int(OneOf1Entity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="OneOf1Entity"/>.</returns>
                    public static explicit operator OneOf1Entity(int value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static implicit operator long(OneOf1Entity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
