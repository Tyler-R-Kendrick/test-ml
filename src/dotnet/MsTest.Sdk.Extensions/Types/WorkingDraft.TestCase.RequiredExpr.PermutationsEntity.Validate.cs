            ...
            public readonly partial struct PermutationsEntity
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://endjin.com/workspaces/test-ml/docs/spec/draft/working-draft.json#/definitions/testCase/properties/act/properties/permutations");
                    }
                ...
                public static partial class CorvusValidation
                {
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        int propertyCount = 0;
                        foreach (JsonObjectProperty<TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity> property in value.EnumerateObject())
                        {
