    ...
    public readonly partial struct JsonValue
    {
        ...
        public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
        {
            ...
            if (level > ValidationLevel.Basic)
            {
                ...
                result = result.PushSchemaLocation("https://endjin.com/workspaces/test-ml/docs/spec/draft/working-draft.json#/definitions/jsonValue");
            }
        ...
        public static partial class CorvusValidation
        {
                ...
                ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                ValidationContext oneOfResult1 = value.As<Corvus.Json.JsonNumber>().Validate(oneOfChildContext1, level);
                ...
                ValidationContext oneOfResult3 = value.As<Corvus.Json.JsonObject>().Validate(oneOfChildContext3, level);
                ...
                ValidationContext oneOfResult4 = value.As<TestML.WorkingDraft.JsonValue.OneOf4Array>().Validate(oneOfChildContext4, level);
                ...
                ValidationContext oneOfResult5 = value.As<Corvus.Json.JsonNull>().Validate(oneOfChildContext5, level);
