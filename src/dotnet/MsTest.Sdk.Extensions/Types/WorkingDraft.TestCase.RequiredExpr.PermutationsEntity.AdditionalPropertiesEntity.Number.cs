...
#if NET8_0_OR_GREATER
                    : IJsonNumber<TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity>,
                      IAdditionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity, TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity, TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity>,
                      ISubtractionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity, TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity, TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity>,
                      IMultiplyOperators<TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity, TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity, TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity>,
                      IDivisionOperators<TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity, TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity, TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity>,
                      IIncrementOperators<TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity>,
                      IDecrementOperators<TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity>
#else
                    : IJsonNumber<TestML.WorkingDraft.TestCase.RequiredExpr.PermutationsEntity.AdditionalPropertiesEntity>
#endif
                {
                    ...
                    public static explicit operator byte(AdditionalPropertiesEntity value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(byte value)
                    {
                    ...
                    public static explicit operator decimal(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(decimal value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator short(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(short value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator int(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(int value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator long(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(long value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator Int128(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(Int128 value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    public static explicit operator sbyte(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(sbyte value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator Half(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(Half value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    public static explicit operator float(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(float value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator ushort(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(ushort value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator uint(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    public static explicit operator ulong(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(ulong value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
                    ...
                    public static explicit operator UInt128(AdditionalPropertiesEntity value)
                    {
                        if ((value.backing & Backing.JsonElement) != 0)
                        {
                    ...
                    /// <param name="value">The value from which to convert.</param>
                    /// <returns>An instance of the <see cref="AdditionalPropertiesEntity"/>.</returns>
                    public static explicit operator AdditionalPropertiesEntity(UInt128 value)
                    {
                        return new(new BinaryJsonNumber(value));
                    }
#endif
                    ...
                    /// </returns>
                    public static bool operator <(AdditionalPropertiesEntity left, AdditionalPropertiesEntity right)
                    {
                    ...
                    public static AdditionalPropertiesEntity operator +(AdditionalPropertiesEntity left, AdditionalPropertiesEntity right)
                    {
                    ...
                    /// <returns>The result of the operation.</returns>
                    public static AdditionalPropertiesEntity operator ++(AdditionalPropertiesEntity value)
                    {
                    ...
                    /// </returns>
                    public static int Compare(in AdditionalPropertiesEntity lhs, in AdditionalPropertiesEntity rhs)
                    {
