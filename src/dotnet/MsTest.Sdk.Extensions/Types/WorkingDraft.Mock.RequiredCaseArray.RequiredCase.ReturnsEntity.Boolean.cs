        ...
        public readonly partial struct RequiredCaseArray
        {
            ...
            public readonly partial struct RequiredCase
            {
                ...
                public readonly partial struct ReturnsEntity
                    : IJsonBoolean<TestML.WorkingDraft.Mock.RequiredCaseArray.RequiredCase.ReturnsEntity>
                {
                    /// <summary>
                    /// Conversion from <see cref="bool"/>.
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator ReturnsEntity(bool value)
                    {
                        return new(value);
                    }
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator ReturnsEntity(JsonBoolean value)
                    {
                    ...
                    /// </summary>
                    /// <param name="value">The value from which to convert.</param>
                    public static implicit operator JsonBoolean(ReturnsEntity value)
                    {
                        return
                            value.AsBoolean;
                    }
                    ...
                    public static implicit operator bool(ReturnsEntity value)
                    {
