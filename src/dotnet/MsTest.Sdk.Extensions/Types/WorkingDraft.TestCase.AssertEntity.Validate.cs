        ...
        public readonly partial struct AssertEntity
        {
            ...
            public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
            {
                ...
                if (level > ValidationLevel.Basic)
                {
                    ...
                    result = result.PushSchemaLocation("https://endjin.com/workspaces/test-ml/docs/spec/draft/working-draft.json#/definitions/testCase/properties/assert");
                }
            ...
            public static partial class CorvusValidation
            {
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    ValidationContext oneOfResult0 = value.As<TestML.WorkingDraft.TestCase.AssertEntity.RequiredReturns>().Validate(oneOfChildContext0, level);
                    ...
                    ValidationContext oneOfResult1 = value.As<TestML.WorkingDraft.TestCase.AssertEntity.RequiredThrows>().Validate(oneOfChildContext1, level);
                    ...
                    ValidationContext oneOfResult2 = value.As<TestML.WorkingDraft.TestCase.AssertEntity.RequiredReturnsAndThrows>().Validate(oneOfChildContext2, level);
                    ...
                    ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    foreach (JsonObjectProperty property in value.EnumerateObject())
                    {
                        if (property.NameEquals(JsonPropertyNames.MocksUtf8, JsonPropertyNames.Mocks))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<TestML.WorkingDraft.TestCase.AssertEntity.RequiredCallsAndIdArray>().Validate(result.CreateChildContext(), level);
                        ...
                        else if (property.NameEquals(JsonPropertyNames.ReturnsUtf8, JsonPropertyNames.Returns))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<TestML.WorkingDraft.TestCase.AssertEntity.ReturnsEntity>().Validate(result.CreateChildContext(), level);
                            if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                            {
                                return propertyResult;
                            }
                        ...
                        else if (property.NameEquals(JsonPropertyNames.ThrowsUtf8, JsonPropertyNames.Throws))
                        {
                            ...
                            ValidationContext propertyResult = property.Value.As<TestML.WorkingDraft.TestCase.AssertEntity.ThrowsEntity>().Validate(result.CreateChildContext(), level);
                            if (level == ValidationLevel.Flag && !propertyResult.IsValid)
                            {
                                return propertyResult;
                            }
