            ...
            public readonly partial struct MockArray
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://endjin.com/workspaces/test-ml/docs/spec/draft/working-draft.json#/definitions/testCase/properties/arrange/properties/mocks");
                    }
                ...
                public static partial class CorvusValidation
                {
                        ...
                        ValidationLevel level)
                    {
                        ...
                        int length = 0;
                        using JsonArrayEnumerator<TestML.WorkingDraft.Mock> arrayEnumerator = value.EnumerateArray();
