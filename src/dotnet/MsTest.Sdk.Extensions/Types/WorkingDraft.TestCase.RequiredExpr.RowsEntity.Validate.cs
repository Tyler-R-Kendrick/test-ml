            ...
            public readonly partial struct RowsEntity
            {
                ...
                public ValidationContext Validate(in ValidationContext validationContext, ValidationLevel level = ValidationLevel.Flag)
                {
                    ...
                    if (level > ValidationLevel.Basic)
                    {
                        ...
                        result = result.PushSchemaLocation("https://endjin.com/workspaces/test-ml/docs/spec/draft/working-draft.json#/definitions/testCase/properties/act/properties/rows");
                    }
                ...
                public static partial class CorvusValidation
                {
                        ...
                        ValidationLevel level = ValidationLevel.Flag)
                    {
                        ...
                        ValidationContext oneOfResult0 = value.As<TestML.WorkingDraft.TestCase.RequiredExpr.RowsEntity.JsonObjectArray>().Validate(oneOfChildContext0, level);
